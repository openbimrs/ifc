...
pub use authoring::{
    ...
    create_externally_defined_style, create_fill_area_style, create_fill_area_style_hatching,
    create_fill_area_style_tiles, create_image_texture, create_indexed_colour_map,
    create_indexed_polygonal_texture_map, create_indexed_triangle_texture_map,
    create_light_distribution_data, create_light_intensity_distribution,
    ...
    create_planar_extent, create_presentation_layer_assignment,
    create_presentation_layer_with_style, create_styled_item, create_surface_style,
    create_surface_style_lighting, create_surface_style_refraction, create_surface_style_rendering,
    create_surface_style_shading, create_surface_style_with_textures, create_text_literal,
    create_text_literal_with_extent, create_text_style, create_text_style_font_model,
    create_text_style_for_defined_font, create_text_style_text_model,
    create_texture_coordinate_generator, create_texture_coordinate_indices,
    create_texture_coordinate_indices_with_voids, create_texture_map, create_texture_vertex,
    create_texture_vertex_list, AnnotationDraft, AnnotationFillAreaDraft, Attenuation,
    BlobTextureDraft, ColourRgbDraft, CurveStyleDraft, CurveWidth, ExternalStyleKind,
    FillStyleKind, GoniometricLight, HatchLineDistance, ImageTextureDraft, LightSourceDraft,
    PixelTextureDraft, PointLight, PresentationLayerDraft, SizeValue, SpotCone, StyledItemDraft,
    SurfaceStyleDraft, SurfaceStyleRenderingDraft, SurfaceStyleShadingDraft, TextLiteralDraft,
    TextLiteralWithExtentDraft, TextModelDraft, PREDEFINED_COLOUR_NAMES,
