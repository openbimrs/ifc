...
pub use authoring::{
    ...
    create_indexed_colour_map, create_indexed_polygonal_texture_map,
    create_indexed_triangle_texture_map, create_light_distribution_data,
    create_light_intensity_distribution, create_light_source_ambient,
    ...
    FillStyleKind, ImageTextureDraft, LightSourceDraft, PixelTextureDraft, PointLight,
    PresentationLayerDraft, SizeValue, SpotCone, StyledItemDraft, SurfaceStyleDraft,
    SurfaceStyleRenderingDraft, SurfaceStyleShadingDraft, TextLiteralDraft,
