#!/usr/bin/env python3
"""Generate docs/research/solibri-geometry-review.md.

Long markdown writes get truncated on this fleet, so the document is
assembled here and written in one go from disk.
"""
import pathlib

OUT = pathlib.Path(__file__).resolve().parents[2] / "docs/research/solibri-geometry-review.md"

PARTS = []
A = PARTS.append

A("""# Review: `solibri/crates/geometry`
